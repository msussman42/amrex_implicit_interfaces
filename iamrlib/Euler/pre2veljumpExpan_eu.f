      function pre2veljumpExpan(comp,sndC)
      implicit none
c
...
c
c 
c     Output: pre2veljumpExpan  --- velocity jump at state W 
c                                       (= dir*(velW-velC))        
c
...
c     Input      
      real*8 comp,sndC
c     Output
      real*8 pre2veljumpExpan
c     Auxiliary
      real*8 compPower

      pre2veljumpExpan = sndC*( rc1*(compPower(comp,gg1)-1.d0) )
