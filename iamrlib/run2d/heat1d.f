...
c      k=0.000433
c thermal diffusivity of water
      k=58000.0/4.1855e+7
c velocity of drop towards the wall (-100)
      vel=-100.0
c diameter of droplet is 0.2
      L=0.0002
      layer=0.0
c temperature of ice
      ulo=272.0
c temperature of supercooled water
      uhi=252.0
      umiddle=252.0
      ncell=4000
      dx=L/ncell
c duration the drop touches the ice
      tstop=0.002
      dt=tstop/ncell
