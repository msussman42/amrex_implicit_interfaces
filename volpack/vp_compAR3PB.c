...
void
VPCompAR3PB (vpc, icount, jcount, k, slice_depth_cueing_dbl, intimage,
...
#define SET_VOXELS_LOADED	voxels_loaded = 1
    ...
    ;
    ;
    shade_func(topRLEdata - voxel_istride, &(top_rclr), &(top_gclr), &(top_bclr),
			     client_data);
...
#           endif
    ...
    ;
    ;
    shade_func(botRLEdata - voxel_istride, &(bot_rclr), &(bot_gclr), &(bot_bclr),
			     client_data);
...
#           endif
    ...
    ;
    ;
    shade_func(topRLEdata, &(top_rclr), &(top_gclr), &(top_bclr),
			     client_data);
    shade_factor = top_opc * slice_depth_cueing;
...
#           endif
    ...
    ;
    ;
    shade_func(botRLEdata, &(bot_rclr), &(bot_gclr), &(bot_bclr),
			     client_data);
    shade_factor = bot_opc * slice_depth_cueing;
