...
!
    ...
    n_r8 = real ( n, kind = rk )
    logten = log ( 10.0D+00 )
    envj = r8_gamma_log_alt ( n_r8 + 1.0D+00 ) / logten - n_r8 * log10 ( x )
...
function r8_gamma_log_alt ( x )

!*****************************************************************************80
!
!! R8_GAMMA_LOG_ALT evaluates the logarithm of the gamma function.
!
!  Discussion:
!
...
!
!    Output, real ( kind = rk ) R8_GAMMA_LOG_ALT, the value of the function.
!
  implicit none
...
subroutine timestamp_alt ( )

!*****************************************************************************80
!
!! TIMESTAMP_ALT prints the current YMDHMS date as a time stamp.
!
!  Example:
!
