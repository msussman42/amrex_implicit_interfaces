...
#include "EXTRAP_COMP.H"
      ...
      real(amrex_real), INTENT(in) :: cchardening_coefficient(ccnum_materials)
      ...
      used_probtypes(26)=3  ! MITSUHIRO_PIPE
      
      SUB_INIT_MODULE=>INIT_STUB_MODULE
      SUB_DEALLOCATE_MODULE=>DEALLOCATE_STUB_MODULE
      SUB_LS=>STUB_LS
      SUB_NUCLEATION_SITES=>STUB_NUCLEATION_SITES
      ...
      if (probtype.eq.421) then
       ...
       SUB_CFL_HELPER=>MITSUHIRO_PIPE_CFL_HELPER
       SUB_INIT_EVAL=>MITSUHIRO_PIPE_INIT_EVAL
       ...
       SUB_ASSIMILATE=>shockdrop_ASSIMILATE
       ...
       SUB_NUCLEATION_SITES=>CAVITY_PHASE_CHANGE_NUCLEATION_SITES
...
!       SUB_clamped_LS_no_scale=>NULL()
      ...
      do im=1,num_materials
       ...
       fort_hardening_coefficient(im)=cchardening_coefficient(im)
      ...
      if (ioproc.eq.1) then
       ...
       do im=1,num_materials
        ...
        print *,"im,fort_hardening_coefficient ",im, &
         fort_hardening_coefficient(im)
