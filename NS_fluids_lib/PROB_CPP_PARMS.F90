...
#include "EXTRAP_COMP.H"
      ...
      subroutine fort_override( &
        ...
        ccstatic_surface_tension_duration, &
        ccstatic_viscosity, &
        ccstatic_tension, &
        cctension, &
        cctension_init, &
      ...
      REAL_T, INTENT(in) :: ccstatic_surface_tension_duration
      REAL_T, INTENT(in) :: ccstatic_viscosity
...
!       SUB_clamped_LS_no_scale=>NULL()
      ...
      fort_static_surface_tension_duration=ccstatic_surface_tension_duration
      fort_static_viscosity=ccstatic_viscosity
      ...
      if (ioproc.eq.1) then
       ...
       print *,"fort_static_surface_tension_duration= ", &
               fort_static_surface_tension_duration
       print *,"fort_static_viscosity= ",fort_static_viscosity
