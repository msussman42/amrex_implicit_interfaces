Module NeuralNetwork
  ...
  Type Ragged_Vector
    REAL_T, Allocatable :: Vec(:)
  End Type Ragged_vector

  Type Ragged_Matrix
    REAL_T, Allocatable :: Mat(:,:)
  ...
  function Predict(self, input)
    Implicit None
    Class(Neural_Network) :: self
    REAL_T :: input(self%n_inputs)
    REAL_T :: Predict(self%n_outputs)
    INTEGER_T :: i
  ...
  function Activation_logistic(n,X)
    ...
    REAL_T, Intent(in), dimension(n) :: X
    REAL_T, dimension(n) :: Activation_logistic
  ...
  function Activation_tanh(n,X)
    ...
    INTEGER_T, Intent(in) :: n
    REAL_T, Intent(in), dimension(n) :: X
    REAL_T, dimension(n) :: Activation_tanh
  ...
  function Activation_ReLU(n,X)
    ...
    INTEGER_T, Intent(in) :: n
    REAL_T, Intent(in), dimension(n) :: X
    REAL_T, dimension(n) :: Activation_ReLU
  ...
  function Activation_identity(n,X)
    ...
    INTEGER_T, Intent(in) :: n
    REAL_T, Intent(in), dimension(n) :: X
    REAL_T, dimension(n) :: Activation_identity
