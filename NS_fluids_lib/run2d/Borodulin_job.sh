#!/bin/bash
#SBATCH --job-name="Borodulin 512 np 4"
#SBATCH --ntasks=4
...
pwd;hostname;date
echo "running amrBorodulin512 on $SLURM_JOB_NUM_NODES nodes with $SLURM_NTASKS tasks, each with $SLURM_CPUS_PER_TASK cores."
module purge
module load gnu openmpi
srun ~/BorodulinETAL/amrBorodulin512 inputs_2d.BorodulinETAL_quarter
