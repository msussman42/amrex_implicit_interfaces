...
RefineElasticInterp       refine_elastic_pc_interp;
...
RefineElasticInterp::~RefineElasticInterp () {}

Box
RefineElasticInterp::CoarseBox (const Box& fine,
  int bfactc,int bfactf,int grid_type)
{
 if ((bfactc<1)||(bfactf<1))
  amrex::Error("bfactc or bfactf invalid");
...
void
RefineElasticInterp::interp (Real time,
  const FArrayBox& crse,
  int               crse_comp,
  FArrayBox&        fine,
  int               fine_comp,
